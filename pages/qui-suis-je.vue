	...
	<div class="relative min-h-screen text-white pt-20">
		...
		<ZigzagLine>
			...
			<p class="text-4xl w-3/5">
				...
				bruts et puissants, que je puise mon inspiration. Entre terres infinies
				et terre de labeur, ma peinture explore le lien profond qui unit les
				hommes à ces paysages : vaches, taureaux et veaux d’Aubrac, symboles à
				la fois de force et de douceur, d'authenticité et de simplicité.
			</p>
