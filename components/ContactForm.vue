<template>
	<div
		class="contact-form-container min-h-screen flex items-center justify-center p-4 backdrop-blur-lg">
		<form
			@submit.prevent="submitForm"
			class="w-full max-w-xl backdrop-blur-md bg-white/20 rounded-3xl shadow-xl p-8 border border-white/30">
			<!-- Progress Indicator -->
			<div class="mb-20 px-10 relative">
			...
			<div
				...
				<div
					v-if="currentStep === 0 && !preSelectedArtwork"
					class="text-center">
			...
			<!-- Navigation Buttons -->
			<div class="flex justify-between mt-8" v-if="!formSubmitted">
				<button
