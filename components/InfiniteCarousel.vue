...
<template>
	<section
		...
		<ul
			...
			aria-label="Première collection de peintures personnalisées">
			<li
		...
		<ul
			...
			:class="['animate-scroll-left', isAnimating ? 'animate-active' : '']"
			aria-label="Seconde collection de peintures personnalisées">
			<li
